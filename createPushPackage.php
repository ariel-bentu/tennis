...
$certificate_path = "/Users/i022021/dev/tennis/ATPenn/cert_with_pk.p12";     // Change this to the path where your certificate is located
$certificate_password = "ariel"; // Change this to the certificate's import password
...
function copy_raw_push_package_files($package_dir) {
    ...
    foreach (raw_files() as $raw_file) {
        copy("/Users/i022021/dev/tennis/ATPenn/my-app/safari-push/safariPushPackage/$raw_file", "$package_dir/$raw_file");
    }
}
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/Users/i022021/dev/tennis/ATPenn/AppleWWDRCA.pem");
